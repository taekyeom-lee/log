...
function EditModal(props) {
  ...
  return <div className={classes.editModal}>
    ...
    <div className={classes.form}>
      <div className={classes.name}>
        ...
        <input className={classes.input} value={props.title} onChange={nameChangeHandler}/>
      </div>
      <div className={classes.url}>
        <div className={classes.text}>URL</div>
        <input className={classes.input} value={props.url} onChange={urlChangeHandler}/>
      </div>
    </div>
